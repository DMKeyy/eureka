package Eureka.Controller;
 ...
 public class SurvivalGameModeController {
    ...
    List<Badge> earnedBadges = BadgeController.checkAndAssignBadges(Player.getCurrentPlayer());
    ...
    try {
        ...
        gameOverController.setScore(score, earnedBadges);  // 👈 On envoie score + badges gagnés
